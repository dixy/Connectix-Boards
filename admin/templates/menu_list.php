...
<select id="<?php echo $list['name']; ?>" 
		name="<?php echo $list['name']; ?>"
		<?php if ( !empty($list['style']) ): ?> style="width:<?php echo $list['style']; ?>px;" <?php endif; ?>
		<?php if ( !empty($list['class']) ): ?> class="<?php echo $list['class']; ?>" <?php endif; ?> 
		onchange="javascript:fast_list('<?php echo $list['name']; ?>');">
<?php $opt=false;
$curoptgroup="";
